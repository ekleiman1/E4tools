...
Note: Visit [this site](http://rpubs.com/ekleiman/E4ToolsVignette) for a copy of the vignette with more examples from executed code. 
...
options(scipen=999)
Table0<-readRDS(paste(system.file(package="E4tools"),"/extdata/vignette_tables/EDA_presses_COMBINED.RDS",sep=""))
Table0a<-head(Table0)
...
#### Sample of RDS output file
```{r, echo=FALSE,eval=TRUE}
Table1<-readRDS(paste(system.file(package="E4tools"),"/extdata/vignette_tables/1002_EDA.RDS",sep=""))
Table1a<-head(Table1)
...
#### Sample of RDS output file
```{r, echo=FALSE,eval=TRUE}
Table2<-readRDS(paste(system.file(package="E4tools"),"/extdata/vignette_tables/EDA_presses_COMBINED.RDS",sep=""))
Table2a<-head(Table2)
...
E4_EDA_Process.part4.BinMatchedEDA(participant_list=c(1001:1003),
                                    rdslocation.MatchedEDA=paste(system.file(package="E4tools"),"/extdata/output/matched_EDA/",sep=""),
                                    rdslocation.BinnedMatchedEDA=paste(system.file(package="E4tools"),"/extdata/output/binned_matched_EDA/",sep=""),
                                   min.after = 20,min.before = 20)
```
#### Sample of RDS output file
...
```{r, echo=FALSE,eval=TRUE}
Table3<-readRDS(paste(system.file(package="E4tools"),"/extdata/vignette_tables/EDA_merged_binned.RDS",sep=""))
Table3a<-head(Table3)
knitr::kable(Table3a, format = "html")
```
