...
options(scipen=999)
Table0<-readRDS(paste(system.file(package="E4tools"),"/extdata/EDA_presses_COMBINED.RDS",sep=""))
Table0a<-head(Table0)
...
#### Sample of RDS output file
```{r, echo=FALSE,eval=TRUE}
Table1<-readRDS(paste(system.file(package="E4tools"),"/extdata/1002_EDA.rds",sep=""))
Table1a<-head(Table1)
...
#### Sample of RDS output file
```{r, echo=FALSE,eval=TRUE}
Table2<-readRDS(paste(system.file(package="E4tools"),"/extdata/EDA_presses_COMBINED.RDS",sep=""))
Table2a<-head(Table2)
...
```{r, echo=FALSE,eval=TRUE}
Table3<-readRDS(paste(system.file(package="E4tools"),"/extdata/EDA_merged_binned.RDS",sep=""))
Table3a<-head(Table3)
